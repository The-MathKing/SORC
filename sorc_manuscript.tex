...
While the bound monotonically tightens as $k \to n$, the maximum over the spectral axes limits the exact recovery of $W_1$ to cases where the optimal coupling perfectly aligns with a single eigenvector. Otherwise, strict inequality holds. In practice, however, this lower bound serves as a highly accurate proxy.
