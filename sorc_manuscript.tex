...
\begin{table}[h]
  \caption{Link Prediction AUC on Real-World Datasets. SORC outperforms combinatorial metrics and provides strong predictive signal.}
...
As shown in Table~\ref{tab:link_prediction}, SORC provides a robust, zero-shot structural heuristic for link prediction. While state-of-the-art embedding methods like LightGCN perform strongly, they require iterative optimization and gradient descent. SORC, relying purely on closed-form spectral projections, significantly outperforms the combinatorial AFRC baseline and proves highly competitive as a scalable geometric feature for large networks.
